    ...
    <div className="min-h-screen bg-background py-8 px-4">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <Card className="overflow-hidden">
          <div className="aspect-video w-full">
            <iframe
              ...
              src="https://www.youtube.com/embed/HlE9u1c_MPQ?autoplay=1&mute=1"
        ...
        <Card className="p-6 text-center bg-gradient-to-br from-green-500/10 to-green-600/5 border-green-500/20">
          <h3 className="text-xl font-bold mb-2">Conheça a Assistente!</h3>
        ...
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-center mb-6">Por que usar a Assistente?</h2>
        ...
        <Card className="p-6">
          <h3 className="text-xl font-bold mb-4">O que a Assistente pode fazer por você?</h3>
