...
const TorturaView = () => {
  ...
  const tableName = "Lei 9.455 de 1997 - Tortura";
  const codeName = "Lei de Tortura";
  const abbreviation = "LT";
  ...
  return (
    <div className="min-h-screen bg-background text-foreground pb-24">
      ...
      <ExplicacaoModal isOpen={modalOpen} onClose={() => setModalOpen(false)} artigo={modalData.artigo} numeroArtigo={modalData.numeroArtigo} tipo={modalData.tipo} nivel={modalData.nivel} codigo="lt" codigoTabela={tableName} />
