...
const BibliotecaLideranca = () => {
  ...
  const { visibleItems, lockedItems, isPremiumRequired } = useContentLimit(livrosFiltrados, 'lideranca');
  ...
  const sobreTexts = BIBLIOTECA_SOBRE_TEXTS.lideranca;
      ...
      <div className="relative h-48 md:h-56 overflow-hidden">
        ...
        <div className="absolute bottom-6 left-6 right-6 text-white">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-bold">Biblioteca de Liderança</h1>
