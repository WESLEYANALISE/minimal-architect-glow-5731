...
const MariaDaPenhaView = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground pb-24">
      ...
      <ExplicacaoModal isOpen={modalOpen} onClose={() => setModalOpen(false)} artigo={modalData.artigo} numeroArtigo={modalData.numeroArtigo} tipo={modalData.tipo} nivel={modalData.nivel} codigo="lmp" codigoTabela={tableName} />
