...
const CrimesHediondosView = () => {
  ...
  const tableName = "Lei 8.072 de 1990 - Crimes Hediondos";
  const codeName = "Lei de Crimes Hediondos";
  ...
  return (
    <div className="min-h-screen bg-background text-foreground pb-24">
      ...
      <ExplicacaoModal isOpen={modalOpen} onClose={() => setModalOpen(false)} artigo={modalData.artigo} numeroArtigo={modalData.numeroArtigo} tipo={modalData.tipo} nivel={modalData.nivel} codigo="lch" codigoTabela={tableName} />
...
export default CrimesHediondosView;