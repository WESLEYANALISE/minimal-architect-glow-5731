...
const OrganizacoesCriminosasView = () => {
  ...
  const tableName = "Lei 12.850 de 2013 - Organizações Criminosas";
  const codeName = "Lei de Organizações Criminosas";
  const abbreviation = "LOC";
  ...
  return (
    <div className="min-h-screen bg-background text-foreground pb-24">
      ...
      <ExplicacaoModal isOpen={modalOpen} onClose={() => setModalOpen(false)} artigo={modalData.artigo} numeroArtigo={modalData.numeroArtigo} tipo={modalData.tipo} nivel={modalData.nivel} codigo="oc" codigoTabela={tableName} />
...
export default OrganizacoesCriminosasView;
