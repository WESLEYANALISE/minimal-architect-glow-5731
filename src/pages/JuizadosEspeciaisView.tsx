...
const JuizadosEspeciaisView = () => {
  ...
  const tableName = "Lei 9.099 de 1995 - Juizados Especiais";
  const codeName = "Juizados Especiais Cíveis e Criminais";
  const abbreviation = "JEC";
  ...
  return (
    <div className="min-h-screen bg-background text-foreground pb-24">
      ...
      <ExplicacaoModal isOpen={modalOpen} onClose={() => setModalOpen(false)} artigo={modalData.artigo} numeroArtigo={modalData.numeroArtigo} tipo={modalData.tipo} nivel={modalData.nivel} codigo="jec" codigoTabela={tableName} />
...
export default JuizadosEspeciaisView;
