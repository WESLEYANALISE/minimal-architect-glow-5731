...
const ROUTE_IMPORTS: Record<string, () => Promise<any>> = {
  ...
  '/ferramentas/questoes': () => import('../pages/ferramentas/QuestoesHubNovo'),
  ...
  '/ferramentas/simulados': () => import('../pages/ferramentas/SimuladosHub'),
  ...
  '/noticias-legislativas': () => import('../pages/NoticiasLegislativas'),
  '/carreiras-juridicas': () => import('../pages/CarreirasJuridicas'),
