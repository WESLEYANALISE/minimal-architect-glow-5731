...
const VIEWS = [
  { id: "estudos", label: "Estudos", desc: "FACULDADE • OAB • CONCURSOS", icon: GraduationCap, headerBg: "linear-gradient(135deg, hsl(350 50% 20%), hsl(355 55% 25%), hsl(350 50% 20%))", footerBg: "linear-gradient(135deg, hsl(350 50% 14%), hsl(355 55% 17%), hsl(350 50% 14%))" },
