...
import capaAulas from "@/assets/capa-aulas.jpg";
import capaResumos from "@/assets/capa-resumos.jpg";
import capaFlashcards from "@/assets/capa-flashcards.jpg";
import capaQuestoes from "@/assets/capa-questoes.jpg";
import capaBiblioteca from "@/assets/capa-biblioteca.jpg";
import capaAudioaulas from "@/assets/capa-audioaulas.jpg";
          ...
          {PRATIQUE_ITEMS.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Content */}
                <div className="relative z-[1] p-3 sm:p-4 flex flex-col items-start justify-center gap-2 h-full">
                  {/* Ghost icon */}
                  <Icon
                  ...
                  <div className="text-left w-full flex items-end justify-between">
                    ...
                    <ChevronRight className="w-3.5 h-3.5 text-white/30 group-hover:text-white/60 transition-colors shrink-0 mb-0.5" />
                  </div>
                </div>
