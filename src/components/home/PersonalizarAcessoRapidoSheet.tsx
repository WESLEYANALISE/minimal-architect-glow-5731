...
const ALL_ITEMS: Omit<AcessoRapidoItem, "enabled">[] = [
  { id: "vade-mecum", title: "Vade Mecum", abbr: "Vade\nMecum", icon: Scale, route: "/vade-mecum", bg: "from-[#0d4a3f] to-[#062a24]", accent: "#d4af37", useImage: true, hideDescription: true },
  { id: "constituicao", title: "Constituição Federal", abbr: "CF88", icon: Landmark, route: "/constituicao", bg: "from-[#7a5c1f] to-[#3d2e0f]", accent: "#f5d060" },
  { id: "codigo-civil", title: "Código Civil", abbr: "CC", icon: Scale, route: "/codigo/cc", bg: "from-[#1e3a6e] to-[#0f1f3d]", accent: "#7ba7e0" },
  { id: "codigo-penal", title: "Código Penal", abbr: "CP", icon: Gavel, route: "/codigo/cp", bg: "from-[#6b1a1a] to-[#3a0e0e]", accent: "#e87c7c" },
  { id: "cpc", title: "Código de Processo Civil", abbr: "CPC", icon: FileText, route: "/codigo/cpc", bg: "from-[#1a4a6b] to-[#0e2a3d]", accent: "#6bbde8" },
  { id: "cpp", title: "Código de Processo Penal", abbr: "CPP", icon: FileText, route: "/codigo/cpp", bg: "from-[#6b3a1a] to-[#3d1f0e]", accent: "#e8a76b" },
  { id: "clt", title: "CLT", abbr: "CLT", icon: Users, route: "/codigo/clt", bg: "from-[#2a1f5e] to-[#160f33]", accent: "#9b8cd4" },
  { id: "cdc", title: "Código do Consumidor", abbr: "CDC", icon: HandCoins, route: "/codigo/cdc", bg: "from-[#1a5e3a] to-[#0e331f]", accent: "#5ec99b" },
  { id: "ctn", title: "Código Tributário Nacional", abbr: "CTN", icon: Scale, route: "/codigo/ctn", bg: "from-[#2a5e1a] to-[#15330e]", accent: "#7cd47c" },
  { id: "ctb", title: "Código de Trânsito", abbr: "CTB", icon: FileText, route: "/codigo/ctb", bg: "from-[#1a4a4a] to-[#0e2a2a]", accent: "#5eb8b8" },
  { id: "ce", title: "Código Eleitoral", abbr: "CE", icon: FileText, route: "/codigo/ce", bg: "from-[#4a1a6b] to-[#2a0e3d]", accent: "#b87ce8" },
  { id: "estatutos", title: "Estatutos", abbr: "EST", icon: BookText, route: "/estatutos", bg: "from-[#3a1a5e] to-[#1f0e33]", accent: "#a07cd4" },
  { id: "sumulas", title: "Súmulas", abbr: "SÚM", icon: ScrollText, route: "/sumulas", bg: "from-[#3a3a4a] to-[#1f1f2a]", accent: "#b0b0c8" },
  { id: "legislacao-penal", title: "Legislação Penal", abbr: "LEP", icon: AlertTriangle, route: "/legislacao-penal-especial", bg: "from-[#5e1a2a] to-[#330e15]", accent: "#d47c8c" },
  { id: "previdenciario", title: "Previdenciário", abbr: "PREV", icon: Shield, route: "/previdenciario", bg: "from-[#3a5e1a] to-[#1f330e]", accent: "#8cd47c" },
  { id: "leis-ordinarias", title: "Leis Ordinárias", abbr: "LO", icon: FileText, route: "/leis-ordinarias", bg: "from-[#1a4a5e] to-[#0e2a33]", accent: "#5eb8d4" },
  { id: "leis-complementares", title: "Leis Complementares", abbr: "LC", icon: FileText, route: "/leis-ordinarias", bg: "from-[#5e1a5e] to-[#330e33]", accent: "#d47cd4" },
];
