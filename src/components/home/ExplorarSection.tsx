          ...
          {itensExplorar.map((item) => {
            ...
            return (
              <button
                ...
                className="group bg-white/15 rounded-2xl p-3 text-left transition-all duration-150 hover:bg-white/20 flex flex-col gap-2 border border-white/[0.08] hover:border-white/20 overflow-hidden relative h-[130px]"
