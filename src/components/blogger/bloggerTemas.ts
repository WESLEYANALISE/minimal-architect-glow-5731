...
import capaLeis from "@/assets/blogger/capa-leis.jpg?format=webp&quality=70&w=400";
import capaCarreiras from "@/assets/blogger/capa-carreiras.jpg?format=webp&quality=70&w=400";
import capaFaculdade from "@/assets/blogger/capa-faculdade.jpg?format=webp&quality=70&w=400";
import capaStf from "@/assets/blogger/capa-stf.jpg?format=webp&quality=70&w=400";
import capaSenado from "@/assets/blogger/capa-senado.jpg?format=webp&quality=70&w=400";
import capaCamara from "@/assets/blogger/capa-camara.jpg?format=webp&quality=70&w=400";
import capaConstitucional from "@/assets/blogger/capa-constitucional.jpg?format=webp&quality=70&w=400";
import capaTribunais from "@/assets/blogger/capa-tribunais.jpg?format=webp&quality=70&w=400";
import capaPenal from "@/assets/blogger/capa-penal.jpg?format=webp&quality=70&w=400";
import capaCivil from "@/assets/blogger/capa-civil.jpg?format=webp&quality=70&w=400";
import capaTrabalho from "@/assets/blogger/capa-trabalho.jpg?format=webp&quality=70&w=400";
import capaAdministrativo from "@/assets/blogger/capa-administrativo.jpg?format=webp&quality=70&w=400";
import capaTributario from "@/assets/blogger/capa-tributario.jpg?format=webp&quality=70&w=400";
import capaAmbiental from "@/assets/blogger/capa-ambiental.jpg?format=webp&quality=70&w=400";
import capaConsumidor from "@/assets/blogger/capa-consumidor.jpg?format=webp&quality=70&w=400";
import capaEmpresarial from "@/assets/blogger/capa-empresarial.jpg?format=webp&quality=70&w=400";
import capaDireitosHumanos from "@/assets/blogger/capa-direitos-humanos.jpg?format=webp&quality=70&w=400";
import capaEleitoral from "@/assets/blogger/capa-eleitoral.jpg?format=webp&quality=70&w=400";

// Cover images - 30 new (WebP optimized)
import capaProcessoCivil from "@/assets/blogger/capa-processo-civil.jpg?format=webp&quality=70&w=400";
import capaProcessoPenal from "@/assets/blogger/capa-processo-penal.jpg?format=webp&quality=70&w=400";
import capaProcessoTrabalho from "@/assets/blogger/capa-processo-trabalho.jpg?format=webp&quality=70&w=400";
import capaPraticaJuridica from "@/assets/blogger/capa-pratica-juridica.jpg?format=webp&quality=70&w=400";
import capaJurisprudencia from "@/assets/blogger/capa-jurisprudencia.jpg?format=webp&quality=70&w=400";
import capaMediacao from "@/assets/blogger/capa-mediacao.jpg?format=webp&quality=70&w=400";
import capaPrevidenciario from "@/assets/blogger/capa-previdenciario.jpg?format=webp&quality=70&w=400";
import capaFinanceiro from "@/assets/blogger/capa-financeiro.jpg?format=webp&quality=70&w=400";
import capaUrbanistico from "@/assets/blogger/capa-urbanistico.jpg?format=webp&quality=70&w=400";
import capaMilitar from "@/assets/blogger/capa-militar.jpg?format=webp&quality=70&w=400";
import capaMaritimo from "@/assets/blogger/capa-maritimo.jpg?format=webp&quality=70&w=400";
import capaSaude from "@/assets/blogger/capa-saude.jpg?format=webp&quality=70&w=400";
import capaImobiliario from "@/assets/blogger/capa-imobiliario.jpg?format=webp&quality=70&w=400";
import capaBancario from "@/assets/blogger/capa-bancario.jpg?format=webp&quality=70&w=400";
import capaAgronegocio from "@/assets/blogger/capa-agronegocio.jpg?format=webp&quality=70&w=400";
import capaFamilia from "@/assets/blogger/capa-familia.jpg?format=webp&quality=70&w=400";
import capaSucessoes from "@/assets/blogger/capa-sucessoes.jpg?format=webp&quality=70&w=400";
import capaContratual from "@/assets/blogger/capa-contratual.jpg?format=webp&quality=70&w=400";
import capaDigital from "@/assets/blogger/capa-digital.jpg?format=webp&quality=70&w=400";
import capaLgpd from "@/assets/blogger/capa-lgpd.jpg?format=webp&quality=70&w=400";
import capaStartups from "@/assets/blogger/capa-startups.jpg?format=webp&quality=70&w=400";
import capaCompliance from "@/assets/blogger/capa-compliance.jpg?format=webp&quality=70&w=400";
import capaDesportivo from "@/assets/blogger/capa-desportivo.jpg?format=webp&quality=70&w=400";
import capaEnergia from "@/assets/blogger/capa-energia.jpg?format=webp&quality=70&w=400";
import capaFilosofia from "@/assets/blogger/capa-filosofia.jpg?format=webp&quality=70&w=400";
import capaSociologia from "@/assets/blogger/capa-sociologia.jpg?format=webp&quality=70&w=400";
import capaHermeneutica from "@/assets/blogger/capa-hermeneutica.jpg?format=webp&quality=70&w=400";
import capaInternacionalPublico from "@/assets/blogger/capa-internacional-publico.jpg?format=webp&quality=70&w=400";
import capaInternacionalPrivado from "@/assets/blogger/capa-internacional-privado.jpg?format=webp&quality=70&w=400";
import capaComparado from "@/assets/blogger/capa-comparado.jpg?format=webp&quality=70&w=400";
