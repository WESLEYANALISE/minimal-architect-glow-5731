  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <Button 
          className="w-full bg-gradient-to-r from-[hsl(var(--accent))]/10 to-[hsl(var(--accent))]/20 hover:from-[hsl(var(--accent))]/20 hover:to-[hsl(var(--accent))]/30 text-foreground border-[hsl(var(--accent))]/40 font-semibold transition-all shadow-md hover:shadow-lg hover:scale-[1.02]"
          variant="outline"
        >
      ...
      <DialogContent className="sm:max-w-[450px] animate-scale-in max-h-[80vh] overflow-y-auto">
        <DialogHeader className="relative pr-8">
          <DialogTitle className="flex items-start gap-2 text-lg leading-tight">
            <Sparkles className="w-5 h-5 text-[hsl(var(--accent))] mt-0.5 flex-shrink-0" />
            <div>
          ...
          {recursos.map((recurso, index) => {
            ...
            return (
              <button
                ...
                className="action-button w-full flex items-start gap-3 px-4 py-3 bg-gradient-to-r from-[hsl(var(--accent))]/10 to-[hsl(var(--accent))]/20 hover:from-[hsl(var(--accent))]/20 hover:to-[hsl(var(--accent))]/30 text-foreground rounded-xl transition-all duration-200 hover:scale-[1.02] border border-[hsl(var(--accent))]/40 shadow-sm hover:shadow-md disabled:opacity-50 disabled:hover:scale-100 text-left"
              >
                <Icon className="w-5 h-5 text-[hsl(var(--accent))] mt-0.5 flex-shrink-0" />
