              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    showIncorrect && errorFlash && "border-red-500 bg-red-500/20 dark:bg-red-500/30 scale-[1.02] transition-transform",
                    showIncorrect && !errorFlash && "border-red-500 bg-red-50 dark:bg-red-950/20",
