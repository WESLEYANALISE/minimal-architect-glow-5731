...
import { Sparkles, BookOpen, Gamepad2, Brain, Trophy } from "lucide-react";
...
export const AulaIntro = ({ onIniciar, isLoading }: AulaIntroProps) => {
      ...
      <Card className="max-w-3xl w-full p-4 sm:p-6 space-y-4 animate-fade-in border border-primary/20">
        <div className="text-center space-y-1">
          ...
          <p className="text-xs sm:text-sm text-muted-foreground">
            Crie uma aula personalizada com IA sobre qualquer tema jurídico
          </p>
        </div>
