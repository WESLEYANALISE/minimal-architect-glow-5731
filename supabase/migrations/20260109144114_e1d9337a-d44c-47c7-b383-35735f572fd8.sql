-- Adicionar campo para armazenar tipo de dispositivo
ALTER TABLE public.profiles ADD COLUMN IF NOT EXISTS dispositivo text;

-- Atualizar a função do trigger para incluir telefone, dispositivo e intenção
...
DECLARE
  payload jsonb;
BEGIN
  -- Preparar payload com dados do novo usuário incluindo telefone, dispositivo e área
