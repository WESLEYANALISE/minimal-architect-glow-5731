...
serve(async (req) => {
  ...
  try {
    ...
    console.log(`[OAB] Processando PDF para matéria ${materiaId}: ${pdfUrl}`);
    ...
    if (contentType.includes('text/html')) {
      throw new Error("O Google Drive retornou uma página HTML ao invés do PDF. Verifique se o arquivo está compartilhado publicamente.");
    }
